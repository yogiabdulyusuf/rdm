...
class rdm_customer(models.Model):
    ...
    ayc_number = fields.Char(string="AYC #", size=50, required=False)
    ...
    phone1 = fields.Char(string="Phone 1", size=20, widget="phone")
    ...
    email = fields.Char(string="Email", required=True, widget="email")
    ...
    def create(self, vals):
        ...
        if is_duplicate:
            raise ValidationError(is_duplicate)
        else:
            # Create Customer
